...
assert(normalizeRole("ADMINISTRATOR") === Roles.SUPER_ADMIN, "normalizeRole('ADMINISTRATOR') -> SUPER_ADMIN")
...
assert(normalizeRole("observer") === Roles.VIEWER, "normalizeRole('observer') -> VIEWER")
